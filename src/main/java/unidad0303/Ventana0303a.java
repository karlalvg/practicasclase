...
public class Ventana0303a extends JFrame implements ActionListener{
    ...
    public void iniciarJCheckBoxs(){
        ...
        this.jCheckBoxList.add(new JCheckBox("Defensa",true));
        this.jCheckBoxList.add(new JCheckBox("Mediocampo",true));
        this.jCheckBoxList.add(new JCheckBox("Delantero",true));
    ...
    public void limpiarDatosIngresados(){
    ...
    public String [] recuperarDatosIngresados(){
        ...
        retorno[0]=this.jTextFieldList.get(1).getText();
     return retorno;  
...
/*if(e.getActionCommand().equals("Cancelar")){
        ...
        if(e.getActionCommand().equals("Defensa")){
            System.out.println("Dio click en en un botón defenso");
        }*/
